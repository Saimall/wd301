...
const TaskCard=(props)=>{
    ...
    if(duedatenumber >= completedatenumber && duemonthnumber >=completemonthnumber)
    {
        var status = "Completed on: "+ completedatenumber+"th"+months[completemonthnumber];
    ...
    return (
        ...
        <p class="text-gray-600 mb-2"><span class="font-bold">Assignee: </span>{props.assigneeName}</p>
        </div>
